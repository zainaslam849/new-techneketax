...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        a { color:#ED141F; text-decoration:none }
        ...
        .l-pink a { color: #ED141F; }
        .l-grey a { color: #6e6e6e; }
        .l-purple a { color: #ED141F; }

        .gradient { background: linear-gradient(to right, #ED141F 0%,#ED141F 100%); }

        .btn-secondary { border-radius: 10px; background: linear-gradient(to right, #ED141F 0%,#ED141F 100%); }
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
                                                                            <a href="#" target="_blank"><img src="'.$imgUrl.'" width="180" height="60" border="0" alt="" /></a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <!-- Logo -->
                                                                                        ...
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="title-36 a-center pb-15" style="font-size:36px; line-height:40px; color:#282828 !important; font-family:PT Sans, Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                                                                    <strong>Your Appointment Has Been Rescheduled - '.$title.'</strong>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                              ...
                                                                                              We want to inform you that your appointment has been successfully rescheduled. Here are the updated details:       
                                                                                             <br>
                                                                                                 
                                                                                                    Title : '.$AppointmentInfo[0]['title'].'. <br>
                                                                                                    Date & Time : '.$formattedDate.'. <br>
                                                                                                   
                                                                                                   <span style="color:#6e6e6e !important;">Purpose : '.$purpose.'.</span> 
                                                                                                    <br>
                                                                                                   We have updated your calendar in your dashboard. Please check your appointments there. 
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td align="center">
                                                                                                    ...
                                                                                                    <table border="0" cellspacing="0" cellpadding="0" style="min-width: 200px;">
                                                                                                        <tr>
                                                                                                            <td class="btn-16 c-white l-white"  style="background-color:#ED141F !important; font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:PT Sans, Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
                                                                                                                <a href="'.$env['APP_URL'].'meet/'.$AppointmentInfo[0]['jitsi_link'].'" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
