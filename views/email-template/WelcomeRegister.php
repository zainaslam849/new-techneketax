                                                                                        ...
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="title-36 a-center pb-15" style="font-size:36px; line-height:40px; color:#282828; font-family:PT Sans, Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                                                                    <strong>Welcome to '.$company_name.' - We are Excited to Have You</strong>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                ...
                                                                                                Welcome to '.$company_name.'
                                                                                                 <br>
                                                                                                 Your account has been successfully created, and you are now part of our community. We are excited to support you                                                                                                    <br><br>
                                                                                                  <br>
                                                                                                  Thank you for choosing '.$company_name.'. We are here to ensure your success.                                                                            
                         <br>
                                                                                                    Thank you,
                                                                                                    <br>
                                                                                                    '.$company_name.' Team
